...
print('\nTime for preprocessing, the training data for Doc2Vec (features extraction) and SGDClassifier training: ',(end-start),' sec')
print('\nFor Doc2Vec and SGDClassifier, f1-score =                 '+str(fs))
