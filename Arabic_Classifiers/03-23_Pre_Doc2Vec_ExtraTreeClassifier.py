...
print('\nTime for preprocessing, the training data for Doc2Vec (features extraction) and ExtraTreeClassifier training: ',(end-start),' sec')
print('\nFor Doc2Vec and ExtraTreeClassifier, f1-score =                 '+str(fs))
