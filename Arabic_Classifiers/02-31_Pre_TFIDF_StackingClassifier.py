...
# estimators  corresponds to the list of the estimators which are stacked together in parallel on the input data. It should be given as a list of names and estimators.
estimators = [('rf', RandomForestClassifier()), ('svr', make_pipeline(StandardScaler(), LinearSVC()))]

# final_estimator parameter of StackingClassifier is classifier which will be used to combine the base estimators. The default classifier is a LogisticRegression.
...
print('\nTime for preprocessing, TFIDF features extraction and StackingClassifier training: ',(end-start),' sec')
print('\nFor TFIDF and StackingClassifier, f1-score =                 '+str(fs))
