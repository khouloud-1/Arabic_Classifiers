...
# The solver parameter of LogisticRegression is the algorithm to use in the optimization problem. By default it's 'lbfgs'
...
print('\nTime for preprocessing, BOW features extraction and LogisticRegression training: ',(end-start),' sec')
print('\nFor BOW and LogisticRegression, f1-score =                 '+str(fs))
