...
print('\nTime for preprocessing, '+str(N)+'gram-BOW features extraction and ExtraTreesClassifier training: ',(end-start),' sec')
print('\nFor '+str(N)+'gram-BOW and ExtraTreesClassifier, f1-score =                 '+str(fs))
