...
print('\nTime for preprocessing, the training data for Doc2Vec (features extraction) and ComplementNB training: ',(end-start),' sec')
print('\nFor Doc2Vec and ComplementNB, f1-score =                 '+str(fs))
