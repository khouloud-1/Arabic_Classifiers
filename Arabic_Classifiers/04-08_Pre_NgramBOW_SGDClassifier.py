...
print('\nTime for preprocessing, '+str(N)+'gram-BOW features extraction and SGDClassifier training: ',(end-start),' sec')
print('\nFor '+str(N)+'gram-BOW and SGDClassifier, f1-score =                 '+str(fs))
