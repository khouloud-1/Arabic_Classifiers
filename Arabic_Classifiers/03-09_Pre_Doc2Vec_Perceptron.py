...
print('\nTime for preprocessing, the training data for Doc2Vec (features extraction) and Perceptron training: ',(end-start),' sec')
print('\nFor Doc2Vec and Perceptron, f1-score =                 '+str(fs))
