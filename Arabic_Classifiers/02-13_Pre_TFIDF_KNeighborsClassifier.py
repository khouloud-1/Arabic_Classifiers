...
# The parameter algorithm of KNeighborsClassifier indicates the algorithm used to compute the nearest neighbors. The default option 'auto' selects the appropriate algorithm.
# The parameter n_neighbors of KNeighborsClassifier indicates the k value of the KNN algorithm. By default it’s 5 
...
print('\nTime for preprocessing, TFIDF features extraction and KNN training: ',(end-start),' sec')
print('\nFor TFIDF and KNN, f1-score =                 '+str(fs))
