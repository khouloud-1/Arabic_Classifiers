...
print('\nTime for preprocessing, HashingVectorizer and HistGradientBoostingClassifier training: ',(end-start),' sec')
print('\nFor HashingVectorizer and HistGradientBoostingClassifier, f1-score =                 '+str(fs))
