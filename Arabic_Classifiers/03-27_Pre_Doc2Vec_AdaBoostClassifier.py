...
print('\nTime for preprocessing, the training data for Doc2Vec (features extraction) and AdaBoostClassifier training: ',(end-start),' sec')
print('\nFor Doc2Vec and AdaBoostClassifier, f1-score =                 '+str(fs))
