...
############################### GaussianNB classifier evaluation #####################################
...
print('\nTime for preprocessing, TFIDF features extraction and GaussianNB training: ',(end-start),' sec')
print('\nFor TFIDF and GaussianNB, f1-score =                 '+str(fs))
