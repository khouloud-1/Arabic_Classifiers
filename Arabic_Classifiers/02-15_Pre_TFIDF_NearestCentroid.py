...
# The parameter metric of NearestCentroid indicates the metric to use when calculating distance between instances in a feature array. 
clf = NearestCentroid()
...
############################### NearestCentroid classifier evaluation #####################################
...
print('\nTime for preprocessing, TFIDF features extraction and NearestCentroid training: ',(end-start),' sec')
print('\nFor TFIDF and NearestCentroid, f1-score =                 '+str(fs))
