...
print('\nTime for preprocessing, '+str(N)+'gram-BOW features extraction and NearestCentroid training: ',(end-start),' sec')
print('\nFor '+str(N)+'gram-BOW and NearestCentroid, f1-score =                 '+str(fs))
