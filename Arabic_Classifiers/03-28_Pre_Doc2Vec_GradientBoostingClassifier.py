...
print('\nTime for preprocessing, the training data for Doc2Vec (features extraction) and GradientBoostingClassifier training: ',(end-start),' sec')
print('\nFor Doc2Vec and GradientBoostingClassifier, f1-score =                 '+str(fs))
