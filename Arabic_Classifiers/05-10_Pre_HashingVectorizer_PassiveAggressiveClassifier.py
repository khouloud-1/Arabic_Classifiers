...
print('\nTime for preprocessing, HashingVectorizer and PassiveAggressiveClassifier training: ',(end-start),' sec')
print('\nFor HashingVectorizer and PassiveAggressiveClassifier, f1-score =                 '+str(fs))
