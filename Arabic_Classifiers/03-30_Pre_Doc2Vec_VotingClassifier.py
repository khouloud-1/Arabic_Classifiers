...
print('\nTime for preprocessing, the training data for Doc2Vec (features extraction) and VotingClassifier training: ',(end-start),' sec')
print('\nFor Doc2Vec and VotingClassifier, f1-score =                 '+str(fs))
