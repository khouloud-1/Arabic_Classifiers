...
# The learning_rate of HistGradientBoostingClassifier (shrinkage) is used as a multiplicative factor for the leaves values. By default it’s 0.1.
# The max_iter of HistGradientBoostingClassifier indicates the maximum number of iterations of the boosting process. By default it’s 100.
...
print('\nTime for preprocessing, TFIDF features extraction and HistGradientBoostingClassifier training: ',(end-start),' sec')
print('\nFor TFIDF and HistGradientBoostingClassifier, f1-score =                 '+str(fs))
