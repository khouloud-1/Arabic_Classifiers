...
print('\nTime for preprocessing, BOW features extraction and GaussianProcessClassifier training: ',(end-start),' sec')
print('\nFor BOW and GaussianProcessClassifier, f1-score =                 '+str(fs))
