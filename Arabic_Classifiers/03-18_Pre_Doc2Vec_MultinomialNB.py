...
print('\nTime for preprocessing, the training data for Doc2Vec (features extraction) and MultinomialNB training: ',(end-start),' sec')
print('\nFor Doc2Vec and MultinomialNB, f1-score =                 '+str(fs))
