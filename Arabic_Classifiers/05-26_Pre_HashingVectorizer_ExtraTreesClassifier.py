...
print('\nTime for preprocessing, HashingVectorizer and ExtraTreesClassifier training: ',(end-start),' sec')
print('\nFor HashingVectorizer and ExtraTreesClassifier, f1-score =                 '+str(fs))
