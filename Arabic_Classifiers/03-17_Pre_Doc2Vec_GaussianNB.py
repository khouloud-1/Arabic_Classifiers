...
print('\nTime for preprocessing, the training data for Doc2Vec (features extraction) and GaussianNB training: ',(end-start),' sec')
print('\nFor Doc2Vec and GaussianNB, f1-score =                 '+str(fs))
