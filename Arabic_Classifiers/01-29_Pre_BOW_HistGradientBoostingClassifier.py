...
print('\nTime for preprocessing, BOW features extraction and HistGradientBoostingClassifier training: ',(end-start),' sec')
print('\nFor BOW and HistGradientBoostingClassifier, f1-score =                 '+str(fs))
