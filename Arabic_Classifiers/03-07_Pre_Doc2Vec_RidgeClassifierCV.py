...
print('\nTime for preprocessing, the training data for Doc2Vec (features extraction) and RidgeClassifierCV training: ',(end-start),' sec')
print('\nFor Doc2Vec and RidgeClassifierCV, f1-score =                 '+str(fs))
