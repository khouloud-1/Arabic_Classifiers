...
print('\nTime for preprocessing, '+str(N)+'gram-BOW features extraction and StackingClassifier training: ',(end-start),' sec')
print('\nFor '+str(N)+'gram-BOW and StackingClassifier, f1-score =                 '+str(fs))
