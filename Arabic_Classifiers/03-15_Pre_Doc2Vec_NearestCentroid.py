...
print('\nTime for preprocessing, the training data for Doc2Vec (features extraction) and NearestCentroid training: ',(end-start),' sec')
print('\nFor Doc2Vec and NearestCentroid, f1-score =                 '+str(fs))
