...
# The n_estimators of GradientBoostingClassifier indicates the number of boosting stages to perform. By default it’s 100.
# The learning_rate of GradientBoostingClassifier shrinks the contribution of each tree. By default it’s 0.1.
...
print('\nTime for preprocessing, TFIDF features extraction and GradientBoostingClassifier training: ',(end-start),' sec')
print('\nFor TFIDF and GradientBoostingClassifier, f1-score =                 '+str(fs))
