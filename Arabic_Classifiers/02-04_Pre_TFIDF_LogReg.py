...
clf = LogisticRegression(solver='liblinear').fit(Xtrain, np.ravel(Ytrain))
...
############################### LogisticRegression classifier evaluation #####################################
...
print('\nTime for preprocessing, TFIDF features extraction and LogisticRegression training: ',(end-start),' sec')
print('\nFor TFIDF and LogisticRegression, f1-score =                 '+str(fs))
