...
print('\nTime for preprocessing, the training data for Doc2Vec (features extraction) and PassiveAggressiveClassifier training: ',(end-start),' sec')
print('\nFor Doc2Vec and PassiveAggressiveClassifier, f1-score =                 '+str(fs))
