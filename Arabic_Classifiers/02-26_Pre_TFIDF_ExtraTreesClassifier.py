...
# Extra-trees classifier implements a meta estimator that fits a number of randomized decision trees
# The n_estimators parameter of ExtraTreesClassifier indicates the number of trees in the forest. By default it’s 100.
...
print('\nTime for preprocessing, TFIDF features extraction and ExtraTreesClassifier training: ',(end-start),' sec')
print('\nFor TFIDF and ExtraTreesClassifier, f1-score =                 '+str(fs))
