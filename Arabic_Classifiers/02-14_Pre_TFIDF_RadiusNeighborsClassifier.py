...
# The parameter algorithm of RadiusNeighborsClassifier indicates the algorithm used to compute the nearest neighbors. The default option 'auto' selects the appropriate algorithm.
# The parameter radius of RadiusNeighborsClassifier indicates the range of parameter space to use for radius_neighbors queries. By default it’s 1.0
...
############################### RadiusNeighborsClassifier evaluation #####################################
...
print('\nTime for preprocessing, TFIDF features extraction and RadiusNeighborsClassifier training: ',(end-start),' sec')
print('\nFor TFIDF and RadiusNeighborsClassifier, f1-score =                 '+str(fs))
