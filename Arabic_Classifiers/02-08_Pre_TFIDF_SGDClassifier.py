...
# The loss parameter of SGDClassifier indicates the loss function to be used. Defaults to ‘hinge’, which gives a linear SVM. loss="log" cortresponds to logistic regression
clf = make_pipeline(StandardScaler(), SGDClassifier(loss="hinge", penalty="l2", max_iter=1000))
...
print('\nTime for preprocessing, TFIDF features extraction and SGDClassifier training: ',(end-start),' sec')
print('\nFor TFIDF and SGDClassifier, f1-score =                 '+str(fs))
