...
print('\nTime for preprocessing, HashingVectorizer and DecisionTreeClassifier training: ',(end-start),' sec')
print('\nFor HashingVectorizer and DecisionTreeClassifier, f1-score =                 '+str(fs))
