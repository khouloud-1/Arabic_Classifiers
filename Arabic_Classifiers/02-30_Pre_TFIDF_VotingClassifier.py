...
# If voting parameter of VotingClassifier is ‘hard’, use predicted class labels for majority rule voting. Else if ‘soft’, predicts the class label based on the argmax of the sums of the predicted probabilities. By default it's ’hard’
clf = VotingClassifier(estimators=[('lr', clf1), ('rf', clf2), ('gnb', clf3), ('dt', clf4), ('knn', clf5), ('svc', clf6)], voting='hard')
...
print('\nTime for preprocessing, TFIDF features extraction and VotingClassifier training: ',(end-start),' sec')
print('\nFor TFIDF and VotingClassifier, f1-score =                 '+str(fs))
