...
print('\nTime for preprocessing, '+str(N)+'gram-BOW features extraction and MultinomialNB training: ',(end-start),' sec')
print('\nFor '+str(N)+'gram-BOW and MultinomialNB, f1-score =                 '+str(fs))
