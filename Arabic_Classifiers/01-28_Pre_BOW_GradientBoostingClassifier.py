...
print('\nTime for preprocessing, BOW features extraction and GradientBoostingClassifier training: ',(end-start),' sec')
print('\nFor BOW and GradientBoostingClassifier, f1-score =                 '+str(fs))
