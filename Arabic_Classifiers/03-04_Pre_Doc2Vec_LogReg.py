...
print('\nTime for preprocessing, the training data for Doc2Vec (features extraction) and LogisticRegression training: ',(end-start),' sec')
print('\nFor Doc2Vec and LogisticRegression, f1-score =                 '+str(fs))
