...
scaler.fit(tf_mat_tr[:,:tf_mat_tr.shape[1]-1])
...
print('\nTime for preprocessing, '+str(N)+'gram-BOW features extraction and MLPClassifier training: ',(end-start),' sec')
print('\nFor '+str(N)+'gram-BOW and MLPClassifier, f1-score =                 '+str(fs))
