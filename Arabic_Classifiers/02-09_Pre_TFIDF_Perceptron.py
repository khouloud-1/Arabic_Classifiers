...
############################### Perceptron classifier evaluation #####################################
...
print('\nTime for preprocessing, TFIDF features extraction and Perceptron training: ',(end-start),' sec')
print('\nFor TFIDF and Perceptron, f1-score =                 '+str(fs))
