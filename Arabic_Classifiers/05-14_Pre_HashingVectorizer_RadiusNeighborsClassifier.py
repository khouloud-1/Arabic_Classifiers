...
print('\nTime for preprocessing, HashingVectorizer and RadiusNeighborsClassifier training: ',(end-start),' sec')
print('\nFor HashingVectorizer and RadiusNeighborsClassifier, f1-score =                 '+str(fs))
