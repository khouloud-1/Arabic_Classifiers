...
# Random forest is a meta estimator that fits a number of decision tree classifiers
# The n_estimators parameter of RandomForestClassifier indicates the number of trees in the forest. By default it’s 100.
...
print('\nTime for preprocessing, TFIDF features extraction and RandomForestClassifier training: ',(end-start),' sec')
print('\nFor TFIDF and RandomForestClassifier, f1-score =                 '+str(fs))
