...
print('\nTime for preprocessing, '+str(N)+'gram-BOW features extraction and GaussianProcessClassifier training: ',(end-start),' sec')
print('\nFor '+str(N)+'gram-BOW and GaussianProcessClassifier, f1-score =                 '+str(fs))
