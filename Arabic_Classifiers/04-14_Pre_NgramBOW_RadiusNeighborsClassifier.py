...
print('\nTime for preprocessing, '+str(N)+'gram-BOW features extraction and RadiusNeighborsClassifier training: ',(end-start),' sec')
print('\nFor '+str(N)+'gram-BOW and RadiusNeighborsClassifier, f1-score =                 '+str(fs))
