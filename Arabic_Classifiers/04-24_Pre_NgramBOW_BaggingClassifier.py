...
print('\nTime for preprocessing, '+str(N)+'gram-BOW features extraction and BaggingClassifier training: ',(end-start),' sec')
print('\nFor '+str(N)+'gram-BOW and BaggingClassifier, f1-score =                 '+str(fs))
