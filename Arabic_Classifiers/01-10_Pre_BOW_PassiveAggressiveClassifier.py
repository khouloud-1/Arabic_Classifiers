...
print('\nTime for preprocessing, BOW features extraction and PassiveAggressiveClassifier training: ',(end-start),' sec')
print('\nFor BOW and PassiveAggressiveClassifier, f1-score =                 '+str(fs))
