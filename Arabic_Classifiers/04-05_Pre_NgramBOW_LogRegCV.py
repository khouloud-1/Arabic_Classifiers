...
print('\nTime for preprocessing, '+str(N)+'gram-BOW features extraction and LogisticRegressionCV training: ',(end-start),' sec')
print('\nFor '+str(N)+'gram-BOW and LogisticRegressionCV, f1-score =                 '+str(fs))
