...
print('\nTime for preprocessing, HashingVectorizer and GradientBoostingClassifier training: ',(end-start),' sec')
print('\nFor HashingVectorizer and GradientBoostingClassifier, f1-score =                 '+str(fs))
...
target_names = ['class 0 (culture)', 'class 1 (diverse)', 'class 2 (economy)', 'class 3 (politic)', 'class 4 (sport)']
