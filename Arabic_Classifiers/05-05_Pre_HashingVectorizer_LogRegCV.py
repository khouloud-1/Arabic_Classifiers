...
print('\nTime for preprocessing, HashingVectorizer and LogisticRegressionCV training: ',(end-start),' sec')
print('\nFor HashingVectorizer and LogisticRegressionCV, f1-score =                 '+str(fs))
