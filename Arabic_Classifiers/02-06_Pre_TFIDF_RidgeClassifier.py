...
clf = RidgeClassifier().fit(Xtrain, np.ravel(Ytrain))
...
print('\nTime for preprocessing, TFIDF features extraction and RidgeClassifier training: ',(end-start),' sec')
print('\nFor TFIDF and RidgeClassifier, f1-score =                 '+str(fs))
