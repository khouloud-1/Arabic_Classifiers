...
print('\nTime for preprocessing, '+str(N)+'gram-BOW features extraction and LogisticRegression training: ',(end-start),' sec')
print('\nFor '+str(N)+'gram-BOW and LogisticRegression, f1-score =                 '+str(fs))
