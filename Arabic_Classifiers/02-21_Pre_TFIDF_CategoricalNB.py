...
############################### CategoricalNB classifier evaluation #####################################
...
print('\nTime for preprocessing, TFIDF features extraction and CategoricalNB training: ',(end-start),' sec')
print('\nFor TFIDF and CategoricalNB, f1-score =                 '+str(fs))
