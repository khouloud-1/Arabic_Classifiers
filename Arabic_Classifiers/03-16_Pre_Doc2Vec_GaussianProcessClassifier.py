...
print('\nTime for preprocessing, the training data for Doc2Vec (features extraction) and GaussianProcessClassifier training: ',(end-start),' sec')
print('\nFor Doc2Vec and GaussianProcessClassifier, f1-score =                 '+str(fs))
