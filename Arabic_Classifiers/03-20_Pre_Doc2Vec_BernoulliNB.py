...
print('\nTime for preprocessing, the training data for Doc2Vec (features extraction) and BernoulliNB training: ',(end-start),' sec')
print('\nFor Doc2Vec and BernoulliNB, f1-score =                 '+str(fs))
