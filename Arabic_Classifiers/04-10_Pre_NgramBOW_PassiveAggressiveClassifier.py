...
print('\nTime for preprocessing, '+str(N)+'gram-BOW features extraction and PassiveAggressiveClassifier training: ',(end-start),' sec')
print('\nFor '+str(N)+'gram-BOW and PassiveAggressiveClassifier, f1-score =                 '+str(fs))
