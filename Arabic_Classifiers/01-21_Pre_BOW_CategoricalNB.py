...
clf = CategoricalNB(min_categories = 25)
...
print('\nTime for preprocessing, BOW features extraction and CategoricalNB training: ',(end-start),' sec')
print('\nFor BOW and CategoricalNB, f1-score =                 '+str(fs))
