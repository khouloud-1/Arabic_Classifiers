...
print('\nTime for preprocessing, BOW features extraction and RadiusNeighborsClassifier training: ',(end-start),' sec')
print('\nFor BOW and RadiusNeighborsClassifier, f1-score =                 '+str(fs))
