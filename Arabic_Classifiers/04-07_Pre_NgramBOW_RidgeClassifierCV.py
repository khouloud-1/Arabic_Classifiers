...
print('\nTime for preprocessing, '+str(N)+'gram-BOW features extraction and RidgeClassifierCV training: ',(end-start),' sec')
print('\nFor '+str(N)+'gram-BOW and RidgeClassifierCV, f1-score =                 '+str(fs))
