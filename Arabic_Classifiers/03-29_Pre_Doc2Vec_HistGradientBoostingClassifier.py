...
print('\nTime for preprocessing, the training data for Doc2Vec (features extraction) and HistGradientBoostingClassifier training: ',(end-start),' sec')
print('\nFor Doc2Vec and HistGradientBoostingClassifier, f1-score =                 '+str(fs))
