...
# the max_iter parameter of MLPClassifier indicates the maximum number of iterations.
...
print('\nTime for preprocessing, HashingVectorizer and MLPClassifier training: ',(end-start),' sec')
print('\nFor HashingVectorizer and MLPClassifier, f1-score =                 '+str(fs))
...
x_vec = scaler.transform(x_vec.toarray())
