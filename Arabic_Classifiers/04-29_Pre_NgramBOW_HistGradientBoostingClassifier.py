...
print('\nTime for preprocessing, '+str(N)+'gram-BOW features extraction and HistGradientBoostingClassifier training: ',(end-start),' sec')
print('\nFor '+str(N)+'gram-BOW and HistGradientBoostingClassifier, f1-score =                 '+str(fs))
