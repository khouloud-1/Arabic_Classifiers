...
# preprocessing.MinMaxScaler allows to scaling features to lie between a given minimum and maximum value. The feature_range parameter indicates the desired range of transformed data ; by default it’s (0, 1).
from sklearn import preprocessing

scaler = preprocessing.MinMaxScaler()
scaler.fit(tfidf_mat_tr[:,:tfidf_mat_tr.shape[1]-1])
...
print('\nTime for preprocessing, TFIDF features extraction and MLPClassifier training: ',(end-start),' sec')
print('\nFor TFIDF and MLPClassifier, f1-score =                 '+str(fs))
