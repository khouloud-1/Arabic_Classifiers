...
print('\nTime for preprocessing, HashingVectorizer and RandomForestClassifier training: ',(end-start),' sec')
print('\nFor HashingVectorizer and RandomForestClassifier, f1-score =                 '+str(fs))
