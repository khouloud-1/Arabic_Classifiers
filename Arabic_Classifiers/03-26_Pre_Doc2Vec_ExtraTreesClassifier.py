...
print('\nTime for preprocessing, the training data for Doc2Vec (features extraction) and ExtraTreesClassifier training: ',(end-start),' sec')
print('\nFor Doc2Vec and ExtraTreesClassifier, f1-score =                 '+str(fs))
