...
print('\nTime for preprocessing, the training data for Doc2Vec (features extraction) and RadiusNeighborsClassifier training: ',(end-start),' sec')
print('\nFor Doc2Vec and RadiusNeighborsClassifier, f1-score =                 '+str(fs))
