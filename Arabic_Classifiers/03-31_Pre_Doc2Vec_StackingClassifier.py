...
print('\nTime for preprocessing, the training data for Doc2Vec (features extraction) and StackingClassifier training: ',(end-start),' sec')
print('\nFor Doc2Vec and StackingClassifier, f1-score =                 '+str(fs))
