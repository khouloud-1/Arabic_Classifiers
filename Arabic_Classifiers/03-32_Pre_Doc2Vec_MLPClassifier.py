...
print('\nTime for preprocessing, the training data for Doc2Vec (features extraction) and MLPClassifier training: ',(end-start),' sec')
print('\nFor Doc2Vec and MLPClassifier, f1-score =                 '+str(fs))
