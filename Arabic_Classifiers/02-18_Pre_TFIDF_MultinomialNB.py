...
############################### MultinomialNB classifier evaluation #####################################
...
print('\nTime for preprocessing, TFIDF features extraction and MultinomialNB training: ',(end-start),' sec')
print('\nFor TFIDF and MultinomialNB, f1-score =                 '+str(fs))
