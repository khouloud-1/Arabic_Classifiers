...
print('\nTime for preprocessing, the training data for Doc2Vec (features extraction) and RidgeClassifier training: ',(end-start),' sec')
print('\nFor Doc2Vec and RidgeClassifier, f1-score =                 '+str(fs))
