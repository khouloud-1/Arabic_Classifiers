...
# The min_categories paramter of CategoricalNB indicates the Minimum number of categories per feature.
clf = CategoricalNB(min_categories = 5)
...
print('\nTime for preprocessing, the training data for Doc2Vec (features extraction) and CategoricalNB training: ',(end-start),' sec')
print('\nFor Doc2Vec and CategoricalNB, f1-score =                 '+str(fs))
