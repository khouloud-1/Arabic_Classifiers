...
print('\nTime for preprocessing, '+str(N)+'gram-BOW features extraction and VotingClassifier training: ',(end-start),' sec')
print('\nFor '+str(N)+'gram-BOW and VotingClassifier, f1-score =                 '+str(fs))
