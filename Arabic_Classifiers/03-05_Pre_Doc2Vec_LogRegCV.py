...
print('\nTime for preprocessing, the training data for Doc2Vec (features extraction) and LogisticRegressionCV training: ',(end-start),' sec')
print('\nFor Doc2Vec and LogisticRegressionCV, f1-score =                 '+str(fs))
