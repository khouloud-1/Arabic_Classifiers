...
print('\nTime for preprocessing, the training data for Doc2Vec (features extraction) and BaggingClassifier training: ',(end-start),' sec')
print('\nFor Doc2Vec and BaggingClassifier, f1-score =                 '+str(fs))
