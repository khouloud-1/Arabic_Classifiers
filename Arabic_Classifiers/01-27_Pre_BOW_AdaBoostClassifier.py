...
print('\nTime for preprocessing, BOW features extraction and AdaBoostClassifier training: ',(end-start),' sec')
print('\nFor BOW and AdaBoostClassifier, f1-score =                 '+str(fs))
...
tf_x.append(dictionary.doc2bow(clean_text(x).split()))
