...
############################### ComplementNB classifier evaluation #####################################
...
print('\nTime for preprocessing, TFIDF features extraction and ComplementNB training: ',(end-start),' sec')
print('\nFor TFIDF and ComplementNB, f1-score =                 '+str(fs))
