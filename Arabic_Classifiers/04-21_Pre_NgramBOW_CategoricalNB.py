...
clf = CategoricalNB(min_categories = 15)
...
print('\nTime for preprocessing, '+str(N)+'gram-BOW features extraction and CategoricalNB training: ',(end-start),' sec')
print('\nFor '+str(N)+'gram-BOW and CategoricalNB, f1-score =                 '+str(fs))
