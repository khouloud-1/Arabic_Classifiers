...
print('\nTime for preprocessing, TFIDF features extraction and PassiveAggressiveClassifier training: ',(end-start),' sec')
print('\nFor TFIDF and PassiveAggressiveClassifier, f1-score =                 '+str(fs))
