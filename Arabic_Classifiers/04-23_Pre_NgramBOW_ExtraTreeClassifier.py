...
print('\nTime for preprocessing, '+str(N)+'gram-BOW features extraction and ExtraTreeClassifier training: ',(end-start),' sec')
print('\nFor '+str(N)+'gram-BOW and ExtraTreeClassifier, f1-score =                 '+str(fs))
