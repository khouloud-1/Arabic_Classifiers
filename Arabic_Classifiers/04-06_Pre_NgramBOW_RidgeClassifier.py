...
print('\nTime for preprocessing, '+str(N)+'gram-BOW features extraction and RidgeClassifier training: ',(end-start),' sec')
print('\nFor '+str(N)+'gram-BOW and RidgeClassifier, f1-score =                 '+str(fs))
