...
print('\nTime for preprocessing, '+str(N)+'gram-BOW features extraction and DecisionTreeClassifier training: ',(end-start),' sec')
print('\nFor '+str(N)+'gram-BOW and DecisionTreeClassifier, f1-score =                 '+str(fs))
