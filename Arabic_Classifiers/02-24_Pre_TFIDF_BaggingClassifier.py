...
# The base_estimator parameter of BaggingClassifier indicates the base estimator to fit on random subsets of the dataset. If None, then the base estimator is a DecisionTreeClassifier.
# The n_estimators parameter of BaggingClassifier indicates the number of base estimators in the ensemble. By default it’s 10.
...
print('\nTime for preprocessing, TFIDF features extraction and BaggingClassifier training: ',(end-start),' sec')
print('\nFor TFIDF and BaggingClassifier, f1-score =                 '+str(fs))
