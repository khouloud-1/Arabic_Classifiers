...
print('\nTime for preprocessing, '+str(N)+'gram-BOW features extraction and GradientBoostingClassifier training: ',(end-start),' sec')
print('\nFor '+str(N)+'gram-BOW and GradientBoostingClassifier, f1-score =                 '+str(fs))
