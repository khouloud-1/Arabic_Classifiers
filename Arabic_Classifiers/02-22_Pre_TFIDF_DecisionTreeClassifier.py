...
print('\nTime for preprocessing, TFIDF features extraction and DecisionTreeClassifier training: ',(end-start),' sec')
print('\nFor TFIDF and DecisionTreeClassifier, f1-score =                 '+str(fs))
