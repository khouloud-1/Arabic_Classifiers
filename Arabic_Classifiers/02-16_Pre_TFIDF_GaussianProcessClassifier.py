...
# The kernel parameter of GaussianProcessClassifier specifies the covariance function of the GP. If None is passed, the kernel “1.0 * RBF(1.0)” is used as default. 
# The multi_class parameter of GaussianProcessClassifier specifies how multi-class classification problems are handled. By dfault it’s ‘one_vs_rest’.
clf = GaussianProcessClassifier(kernel=kernel, random_state=0).fit(Xtrain, np.ravel(Ytrain))

#######################################

end = time.time()

############################### GaussianProcessClassifier evaluation #####################################
...
print('\nTime for preprocessing, TFIDF features extraction and GaussianProcessClassifier training: ',(end-start),' sec')
print('\nFor TFIDF and GaussianProcessClassifier, f1-score =                 '+str(fs))
