...
# The alphas parameter of RidgeClassifierCV is Array of alpha values to try. Regularization strength; must be a positive float. By default alphas is [0.1, 1.0, 10.0]
clf = RidgeClassifierCV(alphas=[1e-3, 1e-2, 1e-1, 1]).fit(Xtrain, np.ravel(Ytrain))

#######################################

end = time.time()

############################### RidgeClassifierCV evaluation #####################################
...
print('\nTime for preprocessing, TFIDF features extraction and RidgeClassifierCV training: ',(end-start),' sec')
print('\nFor TFIDF and RidgeClassifierCV, f1-score =                 '+str(fs))
