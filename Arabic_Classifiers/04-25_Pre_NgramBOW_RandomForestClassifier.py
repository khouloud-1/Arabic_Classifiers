...
print('\nTime for preprocessing, '+str(N)+'gram-BOW features extraction and RandomForestClassifier training: ',(end-start),' sec')
print('\nFor '+str(N)+'gram-BOW and RandomForestClassifier, f1-score =                 '+str(fs))
