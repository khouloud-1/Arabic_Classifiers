...
print('\nTime for preprocessing, the training data for Doc2Vec (features extraction) and RandomForestClassifier training: ',(end-start),' sec')
print('\nFor Doc2Vec and RandomForestClassifier, f1-score =                 '+str(fs))
