...
############################### ExtraTreeClassifier evaluation #####################################
...
print('\nTime for preprocessing, TFIDF features extraction and ExtraTreeClassifier training: ',(end-start),' sec')
print('\nFor TFIDF and ExtraTreeClassifier, f1-score =                 '+str(fs))
