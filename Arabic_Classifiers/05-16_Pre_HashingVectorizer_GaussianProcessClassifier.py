...
print('\nTime for preprocessing, HashingVectorizer and GaussianProcessClassifier training: ',(end-start),' sec')
print('\nFor HashingVectorizer and GaussianProcessClassifier, f1-score =                 '+str(fs))
